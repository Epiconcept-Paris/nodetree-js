...
var Node = function () {
  ...
  */
   ...
   */
		...
		key: 'hashcode2',
		value: function hashcode2(bImmediateScope) {
			var sNodeString = this.toString(bImmediateScope);
			var iStringLength = sNodeString.length;
		...
		key: 'hashcode3',
		value: function hashcode3(bImmediateScope) {
			var sNodeString = this.toString(bImmediateScope);
		...
		key: 'hashcode4',
		value: function hashcode4(bImmediateScope) {
			var sNodeString = this.toString(bImmediateScope);
			...
			for (var i = sNodeString.length; i-- > 0;) {
				...
				iHash = (iHash << 5) + iHash ^ sChar; /* hash * 33 ^ c */
			}
			return iHash;
		}
