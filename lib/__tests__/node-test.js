...
describe('insert', function () {
    ...
    it('should be possible to insert a node at a position', function () {
        ...
        var oExpectedJson = { id: "id_parent", attrs: {},
            child: [{ id: "id_child", attrs: {}, child: [] }, { id: "id_child3", attrs: {}, child: [] }, { id: "id_child2", attrs: {}, child: [] }] };
    ...
    it('should be possible to insert a node before another one', function () {
        ...
        var oExpectedJson = { id: "id_parent", attrs: {},
            child: [{ id: "id_child", attrs: {}, child: [] }, { id: "id_child4", attrs: {}, child: [] }, { id: "id_child3", attrs: {}, child: [] }, { id: "id_child2", attrs: {}, child: [] }] };
    ...
    it('should be possible to insert a node after another one', function () {
        ...
        var oExpectedJson = { id: "id_parent", attrs: {},
            child: [{ id: "id_child", attrs: {}, child: [] }, { id: "id_child4", attrs: {}, child: [] }, { id: "id_child3", attrs: {}, child: [] }, { id: "id_child5", attrs: {}, child: [] }, { id: "id_child2", attrs: {}, child: [] }] };
...
describe('prepend', function () {
    ...
    it('should be possible to prepend a node', function () {
        ...
        var oExpectedJson = { id: "id_parent", attrs: {},
            child: [{ id: "id_child2", attrs: {}, child: [] }, { id: "id_child", attrs: {}, child: [] }] };
        expect(oNodeParent.toString()).toBe(JSON.stringify(oExpectedJson));

        // prepend
        oNodeParent.prepend(oNodeChild3);
        var oExpectedJson = { id: "id_parent", attrs: {},
            child: [{ id: "id_child3", attrs: {}, child: [] }, { id: "id_child2", attrs: {}, child: [] }, { id: "id_child", attrs: {}, child: [] }] };
        expect(oNodeParent.toString()).toBe(JSON.stringify(oExpectedJson));
    });
});
